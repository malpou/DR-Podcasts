...
public class GetPodcastsQueryHandler(IPodcastReadStore podcastReadStore, ILogger<GetPodcastsQueryHandler> logger) : IRequestHandler<GetPodcastsQuery, IEnumerable<Domain.Podcast>>
{
